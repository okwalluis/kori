    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(blank=True, choices=[('B', 'Bancos'), ('C', 'Caja')], max_length=2, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_at', models.DateTimeField(auto_now=True, null=True)),
                ('descripcion', models.CharField(max_length=100, unique=True, verbose_name='Descripción')),
                ('tipo', models.CharField(blank=True, choices=[('D', 'Débito'), ('C', 'Crédito')], max_length=2, null=True)),
                ('activo', models.BooleanField(default=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='DetalleDebitoCredito',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_at', models.DateTimeField(auto_now=True, null=True)),
                ('fecha', models.DateField(default=datetime.datetime.now, verbose_name='Fecha movimiento')),
                ('valor_moneda', models.DecimalField(decimal_places=4, max_digits=16)),
                ('valor_consolidado', models.DecimalField(decimal_places=4, max_digits=16)),
                ('observacion', models.CharField(max_length=100, unique=True, verbose_name='Observación')),
            ],
            options={
