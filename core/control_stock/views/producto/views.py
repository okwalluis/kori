...
from core.control_stock.models import Producto
from core.control_stock.forms import ProductoForm

class ProductoListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    model = Producto
    template_name = 'producto/list.html'
    permission_required = 'control_stock.view_producto'
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'searchdata':
                data = []
                #for i in Producto.objects.filter(empresa_id=request.session.get('user_empresa_id')):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('control_stock:producto_create')
        context['list_url'] = reverse_lazy('control_stock:producto_list')
...
class ProductoCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('control_stock:producto_list')
    permission_required = 'control_stock.add_producto'
...
class ProductoUpdateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, UpdateView):
    ...
    template_name = 'producto/create.html'
    success_url = reverse_lazy('control_stock:producto_list')
    permission_required = 'control_stock.change_producto'
    url_redirect = success_url
...
class ProductoDeleteView(LoginRequiredMixin, ValidatePermissionRequiredMixin, DeleteView):
    ...
    success_url = reverse_lazy('control_stock:producto_list')
    permission_required = 'control_stock.delete_producto'
    url_redirect = success_url
